...
namespace ThunderPropagator.ClusterMessageBuses.NATS
{
    internal sealed partial class NatsClusterMessageBus
    {
        ...
        private NatsClusterResponseEnvelope BuildFetchSubscriptionsResponse(NatsClusterRequestEnvelope request)
        {
            ...
            return new NatsClusterResponseEnvelope(true, null, descriptors.ToNJson());
        }

        private static partial class Log
        {
            [LoggerMessage(EventId = 9750, Level = LogLevel.Warning,
                Message = "[Cluster] Fetching subscriptions from NATS peer '{Host}' failed.")]
