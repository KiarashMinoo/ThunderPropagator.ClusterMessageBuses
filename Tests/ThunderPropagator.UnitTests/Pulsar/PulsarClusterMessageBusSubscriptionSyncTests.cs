...
public class PulsarClusterMessageBusSubscriptionSyncTests
{
    ...
    public async Task PublishAsync_StampsOriginId_AndPublishesToTheSubscriptionEventTopic()
    {
        ...
        var expectedTopic = PulsarTopicNaming.SubscriptionEventTopic("persistent://public/default/thunderpropagator-cluster", channelKey);
